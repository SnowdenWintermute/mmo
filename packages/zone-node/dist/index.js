...
const handleZoneManagerMessages_1 = __importDefault(require("./subscription-handlers/handleZoneManagerMessages/handleZoneManagerMessages"));
...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    subscriber.subscribe(`zone-manager-updates-for-zone-${zone.id}`, (message) => (0, handleZoneManagerMessages_1.default)(message, zone));
